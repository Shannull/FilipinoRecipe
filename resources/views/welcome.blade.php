...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <img class="h-12 w-auto lg:h-16" src="{{ asset('images/63.png') }}" alt="Image Description">
</div>
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                            <video class="rounded-full" autoplay loop muted>
                                                <source src="{{ asset('videos/menu.mp4') }}" type="video/mp4">
                                            </video>
                                        </div>
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Filipino Recipes</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Welcome to Filipino Recipes, a community-driven platform for sharing and discovering Filipino recipes.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <video class="rounded-full" autoplay loop muted>
                                        <source src="{{ asset('videos/map.mp4') }}" type="video/mp4">
                                    </video>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Explore Recipes</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Browse a wide range of Filipino dishes, from traditional favorites to modern twists.
                                    </p>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <video class="rounded-full" autoplay loop muted>
                                        <source src="{{ asset('videos/transfer.mp4') }}" type="video/mp4">
                                    </video>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Share Your Own</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Contribute to the community by sharing your own recipe creations. You can also share your own blog posts, tutorials, and more.
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Connect with Foodies</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        <a href="#">Connect with foodies from all over the world. Share your favorite recipes, cooking tips, and more. Join our community today!</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <footer class="py-16 text-center text-sm text-gray-600">
                        <span>Shann wanna be Programmer</span>
                    </footer>
                </div>
            </div>
        </div>
